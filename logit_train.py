...
from model_config import model_config, logistic_config
from default_predictor import BaselineModel, LogisticRegressor
...
for train_index, test_index in skf.split(X, y):
    ...
    model = LogisticRegressor(name = "default-predictor", uuid = unique_model_uuid)
    model.build(config=logistic_config)
